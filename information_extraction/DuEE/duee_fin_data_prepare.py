...
if __name__ == "__main__":
    ...
    # 录入事件schema路径
    schema_path = "/Users/geng/Documents/data/DuEE-fin/duee_fin_schema/duee_fin_event_schema.json"
    # 录入触发词字典路径
    ...
    train_sent = docs_data_process(
        "/Users/geng/Documents/data/DuEE-fin/duee_fin_train.json/duee_fin_train.json")
    write_by_lines("{}/train.json".format(sentence_dir), train_sent)
    dev_sent = docs_data_process(
        "/Users/geng/Documents/data/DuEE-fin/duee_fin_dev.json/duee_fin_dev.json")
    write_by_lines("{}/dev.json".format(sentence_dir), dev_sent)
    test_sent = docs_data_process(
        "/Users/geng/Documents/data/DuEE-fin/duee_fin_test2.json/duee_fin_test2.json")
